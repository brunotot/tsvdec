...
import { PrimitiveUnionOverride } from "../../overrides";
 ...
 * [@Enhancer]
 *
 * If a field which is being decorated is not a {@link Types.PrimitiveUnion primitive}
 * (`string`, `number`, `boolean`, `bigint`, `Date`) and isn't marked as a primitive in {@link PrimitiveUnionOverride overrides} interface
 ...
 * }
 */
export function attribute<Value extends Types.Optional<object | object[]>, This>(
