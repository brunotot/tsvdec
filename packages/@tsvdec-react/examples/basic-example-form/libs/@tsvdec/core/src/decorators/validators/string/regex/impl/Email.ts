 ...
 * [@Validator]
 *
 * @key {@link DecoratorValidationKeys.EMAIL}
...
export function Email<This, Value extends Types.Optional<string>>(
  ...
  return makeValidator(options, DecoratorValidationKeys.EMAIL, (value, { locale }) => ({
    valid: isEmailValid(value),
    message: translate(locale, DecoratorValidationKeys.EMAIL),
  }));
}
