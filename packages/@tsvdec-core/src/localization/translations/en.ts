export default {
  ...
  ArrayEvery: "Not all inputs satisfy a given criteria",
  ArrayNone: "All inputs must not satisfy a given criteria",
  ArrayOne: "This dataset requires exactly one value (0 and 2+ are disallowed)",
  ...
  ArraySome: "At least one input must satisfy a given criteria",
  ...
  Pattern: "Value doesn't satisfy the following regular expression: {0}",
