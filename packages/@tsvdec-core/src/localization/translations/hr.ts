export default {
  ...
  Digits:
    "Integer part of the number can have a maximum of {0} digits and fraction part a maximum of {1}",
  Email: "Unos nije pravilni email",
  ExactLength: "Unos mora sadržavati točno {0} znakova",
  AssertFalse: "Vrijednost mora biti negativna",
  ...
  AssertTrue: "Vrijednost mora biti pozitivna",
  ...
  Pattern: "Vrijednost ne zadovoljava sljedeći regularni izraz: {0}",
  ArrayEvery: "Ne zadovoljavaju svi ulazi zadane kriterije",
  ArrayNone: "Svi ulazi ne smiju zadovoljiti zadane kriterije",
  ArrayOne: "Ovaj skup podataka zahtijeva točno jednu vrijednost (0 i 2+ nisu dopušteni)",
  ArraySome: "Najmanje jedan unos mora zadovoljiti zadani kriterij",
} as const;
