 ...
 * [@Validator]
 *
 * @key {@link DecoratorValidationKeys.LOWERCASE}
...
export function Lowercase<This, Value extends Types.Optional<string>>(
  ...
  return makeValidator(options, DecoratorValidationKeys.LOWERCASE, (value, { locale }) => ({
    valid: isLowercaseValid(value),
    message: translate(locale, DecoratorValidationKeys.LOWERCASE),
  }));
}
